...
IF EXIST bin_x86_Release_vs2017 (
  call "Build/RH/ResourceHacker.exe" -addoverwrite "bin_x86_Release_vs2017/ascii_player.exe", "bin_x86_Release_vs2017/ascii_player.exe", "Resources/ASCII_Player.ico", ICONGROUP, MAINICON, 0
...
IF EXIST bin_x64_Debug_vs2017 (
  call "Build/RH/ResourceHacker.exe" -addoverwrite "bin_x64_Debug_vs2017/ascii_player.exe", "bin_x64_Debug_vs2017/ascii_player.exe", "Resources/ASCII_Player.ico", ICONGROUP, MAINICON, 0
...
IF EXIST bin_x64_Release_vs2017 (
  call "Build/RH/ResourceHacker.exe" -addoverwrite "bin_x64_Release_vs2017/ascii_player.exe", "bin_x64_Release_vs2017/ascii_player.exe", "Resources/ASCII_Player.ico", ICONGROUP, MAINICON, 0
