@echo off
rem Terrible hardcoded batch file for moving the file I use to update my working version of ASCIIPlayer on just my machines. -mc
rem I will inevitably forget that this favors the release build.
cd ..
